...
# The new Mendix Custom Widget Boilerplate for building Custom Mendix Widgets in React and Redux in ES6.

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/richardedens/mendix-react-redux-boilerplate.git` or [download the zip](https://github.com/richardedens/mendix-react-redux-boilerplate/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd mendix-react-redux-boilerplate`
...
## Use with the Visual Studio Code IDE

You are able to use script snippets within the Visual Studio Code editor that are written to ease the implementation of redux enabled container React components. The following short commands are explained:

### Visual Studio Code snippet short-cut commands
| **Command** | **Use** |
|----------|-------|
|react-redux-action|Creates a Redux action.|
|react-redux-container-component|An ES6 class bases React component with Redux enabled on it.|
|react-redux-presentation-component|An ES6 stateless React component class.|
|react-redux-store|An ES6 redux store file. (Remember this can only be one!)|
|react-redux-root-reducer|Combine all reducer classes inside the root reducer.|
|react-redux-reducer|An ES6 redux reducer file.|
